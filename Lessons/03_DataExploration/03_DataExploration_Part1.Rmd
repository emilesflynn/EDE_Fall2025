...
#file location is the "absolute pathway" on your computer VS "relative path" is pointing to a file considering where you are right now (ex. start at working directory to someplace else)
