...
```{r The here package}
##here guarantees that you create a relative pathway to your files. 
...
#Read in all CSV files starting with "EPAair_03" into a single dataframe
folder <-here('Data','Raw')
files1 <- dir(folder, pattern = "EPAair_O3_NC2018_raw.csv", full.names = TRUE)
files2 <-dir(folder, pattern = "EPAair_O3_NC2019_raw.csv", full.names = TRUE)
